...
//var xmlreq = require('./xmlhttprequest');
...
jsdom.env({
    ...
    , done : function(errors, window) {
        ...
        var el = window.document.querySelector('#dataviz-container')
            ...
            , networkId = 'a2324'  // say, this value was dynamically retrieved from some database
        ...
        //console.log(path.dirname(fs.realpathSync('views/graph.json')));

        // http://stackoverflow.com/a/22492384/5490125
        //fs.readFile('views/graph.json', 'utf-8', function(error, data) {
        ...
        var clientScript = "d3.select('#" + networkId + "').transition().delay(1000).attr('fill', '#f9af26')"
